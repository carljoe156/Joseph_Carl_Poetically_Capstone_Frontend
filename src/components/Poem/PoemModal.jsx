  ...
  return (
    ...
    >
      ...
      >
        ...
        <h4 className="my-2 text-gray-500">{poem._id}</h4>
        <div className="flex justify-start items-center gap-x-2">
          <PiBookOpenTextLight className="text-red-300 text-2xl" />
          <h2 className="my-1">{poem.title}</h2>
        </div>
        <div className="flex justify-start items-center gap-x-2">
          <BiUserCircle className="text-red-400 text-2xl" />
          <h2 className="my-1">{poem.author}</h2>
        </div>
        <p className="mt-4"> </p>
        <p className="my-2">
          <p>
          ...
          <p>
            <strong>
              Please remember to be kind and thoughtful when sharing your poems
              with others.
            </strong>
          </p>
          &nbsp;
